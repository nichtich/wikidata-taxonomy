...
// equivalent properties of mapping properties
const mappingPropertyEquivalences = {
...
function addMapping (concept, mapping, property) {
  if (!mapping) {
    return
  }

  var mappingType = property in mappingPropertyEquivalences
    ? mappingPropertyEquivalences[property]
    : [ 'http://www.w3.org/2004/02/skos/core#mappingRelation' ]
  mappingType.push('http://www.wikidata.org/entity/' + property)
